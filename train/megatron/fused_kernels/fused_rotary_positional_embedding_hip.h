                                 ...
                                 scalar_t* output)
{
   ...
   hipLaunchKernelGGL(( fused_rope_forward), dim3(blocks), dim3(threads), 0, stream, h,
                                                       d,
                                                       d2,
                                                       stride_s,
                                                       stride_b,
                                  ...
                                  scalar_t* input_grads)
{
   ...
   hipLaunchKernelGGL(( fused_rope_backward), dim3(blocks), dim3(threads), 0, stream, h,
                                                        d,
                                                        d2,
                                                        stride_s,
                                                        stride_b,
                                        ...
                                        scalar_t_0* output)
{
   ...
   hipLaunchKernelGGL(( fused_rope_cached_forward), dim3(blocks), dim3(threads), 0, stream, h,
                                                              d,
                                                              d2,
                                                              stride_s,
                                                              stride_b,
                                         ...
                                         scalar_t_0* input_grads)
{
   ...
   hipLaunchKernelGGL(( fused_rope_cached_backward), dim3(blocks), dim3(threads), 0, stream, h,
                                                               d,
                                                               d2,
                                                               stride_s,
                                                               stride_b,
